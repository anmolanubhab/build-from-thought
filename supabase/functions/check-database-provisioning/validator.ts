// path: supabase/functions/check-database-provisioning/validator.ts
...
//
// NOTE: an identical copy lives in supabase/functions/generate-app/validator.ts, supabase/functions/edit-project/validator.ts, and supabase/functions/provision-database/validator.ts —
